...
\begin{algorithm}
  ...
  \For{$i \gets 2, \dots, n$}
    ...
    \ForAll{$(\theta, s, f) \in A \times S \times F$}
      ...
      \State $a_1 \gets f \cdot R_i(0, 0, 1) + (0, 0, -9.81)$
      \State $t \gets t_i$
